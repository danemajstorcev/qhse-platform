...
export default function DocumentControl() {
  ...
  const handleExportCSV = () => {
    const headers = ['ID', 'Title', 'Standard', 'Category', 'Version', 'Status', 'Owner', 'Last Modified']
    const rows = documents.map(d => [d.id, d.title, d.standard, d.category, d.version, d.status, d.owner, d.lastModified])
