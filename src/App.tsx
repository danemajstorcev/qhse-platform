...
import { risks as initialRisks, incidents as initialIncidents } from './data/mockData'
...
export default function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      case 'dashboard':    return <Dashboard risks={risks} incidents={incidents} />
      case 'risk':         return <RiskAssessment risks={risks} onRisksChange={setRisks} />
      case 'incidents':    return <IncidentTracking incidents={incidents} onIncidentsChange={setIncidents} />
      ...
      default:             return <Dashboard risks={risks} incidents={incidents} />
    }
  }
