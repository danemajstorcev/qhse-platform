...
export default function RiskMatrix({ risks }: Props) {
  ...
  return (
    <div className="card">
      <div className="card-header">
        <div>
          ...
          <div className="card-subtitle">
            Likelihood × Severity — tap cells to see risks
          </div>
        </div>
      </div>
          ...
          >
            ...
            {[5, 4, 3, 2, 1].map((likelihood) =>
              [1, 2, 3, 4, 5].map((severity) => {
                ...
                const isHovered =
                  hoveredCell?.l === likelihood && hoveredCell?.s === severity;
                ...
                return (
                  <div
                    ...
                    style={{
                      gridRow: 6 - likelihood,
                      gridColumn: severity + 1,
                    }}
                    onMouseEnter={() =>
                      setHoveredCell({ l: likelihood, s: severity })
                    }
      ...
      {hoveredCell &&
        getRisksAtCell(hoveredCell.l, hoveredCell.s).length > 0 && (
          <div
            style={{
              marginTop: 12,
              padding: "10px 12px",
          ...
          >
            ...
            >
              L={hoveredCell.l} × S={hoveredCell.s} — Score{" "}
              {hoveredCell.l * hoveredCell.s}
            </div>
