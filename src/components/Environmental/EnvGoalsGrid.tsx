            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                ...
                <span style={{
                  ...
                  background: onTrack ? 'var(--emerald-dim)' : 'var(--red-dim)',
                  padding: '2px 8px',
                  borderRadius: 99,
                }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 10 }}>
                <div>
                  ...
                  <div style={{ fontSize: 18, fontWeight: 800, color: cfg.color, fontFamily: 'JetBrains Mono, monospace' }}>
                    {current.toLocaleString()}
                  </div>
                </div>
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontSize: 11, color: 'var(--text-muted)', marginBottom: 2 }}>Target</div>
                  <div style={{ fontSize: 18, fontWeight: 800, color: 'var(--text-secondary)', fontFamily: 'JetBrains Mono, monospace' }}>
              ...
              <div className="metric-progress-bar" style={{ height: 6 }}>
                <div
                  ...
                  style={{ width: `${Math.min(100, pct)}%`, background: onTrack ? cfg.color : 'var(--red)' }}
                />
              </div>
