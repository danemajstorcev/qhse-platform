...
const TYPE_DESCRIPTIONS: Record<FindingType, string> = {
  "Major NC":
    "A significant failure to meet a requirement that affects the system's ability to achieve intended results.",
  "Minor NC":
    "A single lapse or isolated failure against a specific requirement.",
  Observation:
    "A situation that, while not yet a nonconformity, may become one if not addressed.",
              ...
              style={{
                ...
                background:
                  form.type === t
                    ...
                    : "var(--surface-raised)",
                color:
                  form.type === t ? TYPE_COLOR[t] : "var(--text-secondary)",
                cursor: "pointer",
                fontSize: 12,
                fontWeight: 700,
                textAlign: "left",
